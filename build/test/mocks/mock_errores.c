...
void RegistrarMensaje(int gravedad, const char* funcion, int linea, const char* mensaje)
{
  ...
  if (!cmock_call_instance->IgnoreArg_gravedad)
  {
    ...
    UNITY_TEST_ASSERT_EQUAL_INT(cmock_call_instance->Expected_gravedad, gravedad, cmock_line, CMockStringMismatch);
  }
...
void CMockExpectParameters_RegistrarMensaje(CMOCK_RegistrarMensaje_CALL_INSTANCE* cmock_call_instance, int gravedad, const char* funcion, int linea, const char* mensaje);
void CMockExpectParameters_RegistrarMensaje(CMOCK_RegistrarMensaje_CALL_INSTANCE* cmock_call_instance, int gravedad, const char* funcion, int linea, const char* mensaje)
{
  cmock_call_instance->Expected_gravedad = gravedad;
...
void RegistrarMensaje_CMockExpect(UNITY_LINE_TYPE cmock_line, int gravedad, const char* funcion, int linea, const char* mensaje)
{
